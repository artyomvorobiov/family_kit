...
import 'my_drug_card.dart';

class MyMedicineList extends StatefulWidget {
  static const routeName = '/list';

  @override
  State<MyMedicineList> createState() => MyMedicineListState();

  static MyMedicineListState? of(BuildContext context) {
    return context.findAncestorStateOfType<MyMedicineListState>();
  }
}

class MyMedicineListState extends State<MyMedicineList> {
